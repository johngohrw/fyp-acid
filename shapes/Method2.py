...
class Shapes:
    ...
    def __init__ (self, imageName):
        ...
        img_path = os.path.join(currentDir, imageName )
    ...
    def preProcess(self):
        img_blur = self.medianBlurImage(self.image)
...
def writeToFile (toWrite):
    ...
    resultingArea.write(str(the_features))
    resultingArea.write('\n')
    resultArea.close()
...
if __name__ == "__main__":    
    ...
    shape = Shapes(img_name)
    the_features = shape.boxFeatures()
