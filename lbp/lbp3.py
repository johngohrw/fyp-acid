...
lbp0 = LocalBinaryPatterns(8, 2, "uniform") #number of points, radius
lbp1 = LocalBinaryPatterns(8, 8, "uniform") #number of points, radius
lbp2 = LocalBinaryPatterns(8, 24, "uniform") #number of points, radius
lbp3 = LocalBinaryPatterns(8, 48, "uniform") #number of points, radius
lbp4 = LocalBinaryPatterns(8, 64, "uniform") #number of points, radius
lbp5 = LocalBinaryPatterns(1, 96, "uniform") #number of points, radius

lbps = [lbp0,lbp1,lbp2,lbp3,lbp4,lbp5]
